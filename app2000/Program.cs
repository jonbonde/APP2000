...
builder.Services.AddCors(options =>
{
    options.AddPolicy("CORSPolicy", 
        builder =>
        {
            ...
            .AllowAnyMethod()
            .AllowAnyHeader()
            .WithOrigins("http://localhost:3000", "https://green-mushroom-076af7c03.3.azurestaticapps.net");
        });
});
...
{
    swaggerGenOptions.SwaggerDoc("v1", new OpenApiInfo { Title = "APP2000 Prosjekt", Version = "v1" });
});
...
{
    swaggerUIOptions.DocumentTitle = "APP2000 Prosjekt";
    swaggerUIOptions.SwaggerEndpoint("/swagger/v1/swagger.json", "Web API serving a very cool Post model.");
